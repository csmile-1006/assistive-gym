...
class FeedingPR2MeshEnv(FeedingMeshEnv):
    def __init__(self):
        super().__init__(robot=PR2(robot_arm), human=HumanMesh())


class FeedingBaxterMeshEnv(FeedingMeshEnv):
    def __init__(self):
        super().__init__(robot=Baxter(robot_arm), human=HumanMesh())


class FeedingSawyerMeshEnv(FeedingMeshEnv):
    def __init__(self):
        super().__init__(robot=Sawyer(robot_arm), human=HumanMesh())


class FeedingJacoMeshEnv(FeedingMeshEnv):
    def __init__(self):
        super().__init__(robot=Jaco(robot_arm), human=HumanMesh())


class FeedingStretchMeshEnv(FeedingMeshEnv):
    def __init__(self):
        super().__init__(robot=Stretch("wheel_" + robot_arm), human=HumanMesh())


class FeedingPandaMeshEnv(FeedingMeshEnv):
    def __init__(self):
        super().__init__(robot=Panda(robot_arm), human=HumanMesh())
