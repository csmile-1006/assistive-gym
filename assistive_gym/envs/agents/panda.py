...
class Panda(Robot):
    def __init__(self, controllable_joints="right"):
        ...
        gripper_pos = {
            "scratch_itch": [0.02] * 2,  # Gripper open position for holding tools, in [0, 0.04]
            "feeding": [0.001] * 2,
            "drinking": [0.035] * 2,
            "bed_bathing": [0.02] * 2,
            "dressing": [0.001] * 2,
        ...
        tool_orient_offset = {
            "scratch_itch": [0, -np.pi / 2.0, 0],  # RPY orientation offset between tool and robot tool joint
