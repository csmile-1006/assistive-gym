...
class Stretch(Robot):
    def __init__(self, controllable_joints="right"):
        ...
        tool_pos_offset = {
            "scratch_itch": [0, 0, 0],  # Position offset between tool and robot tool joint
            "feeding": [0.1, 0, -0.02],
            "drinking": [0, 0, -0.05],
            "bed_bathing": [0, 0, 0],
        ...
        tool_orient_offset = {
            "scratch_itch": [0, 0, 0],  # RPY orientation offset between tool and robot tool joint
        ...
        toc_base_pos_offset = {
            "scratch_itch": [-1.0, -0.1, 0.09],  # Robot base offset before TOC base pose optimization
        ...
        self.all_controllable_joints = (
            [0, 1, 3, 5, 6, 7, 8, 9] if "wheel" in controllable_joints else [3, 5, 6, 7, 8, 9]
        )
    ...
    def init(self, directory, id, np_random, fixed_base=False):
        ...
        super().init(self.body, id, np_random)
