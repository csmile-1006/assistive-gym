...
class Sawyer(Robot):
    def __init__(self, controllable_joints="right"):
        ...
        tool_pos_offset = {
            "scratch_itch": [0, 0.125, 0],  # Position offset between tool and robot tool joint
        ...
        tool_orient_offset = {
            "scratch_itch": [0, 0, np.pi / 2.0],  # RPY orientation offset between tool and robot tool joint
        ...
        toc_base_pos_offset = {
            "scratch_itch": [-0.1, 0, 0.975],  # Robot base offset before TOC base pose optimization
